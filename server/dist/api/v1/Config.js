...
let Config = class Config {
    retrieve(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let admin = yield Users_1.Users.findOne({ role: 'admin' });
            if (!admin && process.env.ADMIN_USERNAME) {
                admin = yield Users_1.Users.findOne({ username: process.env.ADMIN_USERNAME });
                admin.role = 'admin';
                yield admin.save();
            }
            let config = yield Config_1.Config.findOne();
            if (!config) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const model = yield Config_1.Config.findOne();
