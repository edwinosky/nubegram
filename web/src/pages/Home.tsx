          ...
          <Layout.Content>
            ...
            <Typography.Paragraph>
              <Space>
                ...
                <GitHubButton href="" data-show-count="true" aria-label=""></GitHubButton>
              </Space>
            </Typography.Paragraph>
        ...
        <Col span={20} offset={2}>
          <Row gutter={72}>
            ...
            <Col lg={8} span={24} style={{ textAlign: 'center', marginBottom: '30px' }}>
              ...
              <Typography.Paragraph>
                You can control the sharing options for every file that you upload on Nubegram. By default, it's private for you in your Saved Messages.
              </Typography.Paragraph>
            </Col>
          </Row>
        </Col>
